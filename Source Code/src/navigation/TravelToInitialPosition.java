...
/**
 * "TravelToInitialPosition" class is responsible of travelling the robot to
 * its starting corner
 * 
 * @author Irmak Pakis 
 * @dateCreated November 20, 2018
 * @version 1.0
 * @editHistory Irmak Pakis - Creation of the class (20/11/2018) (1.0)
 *
 */
public class TravelToInitialPosition {
	...
	private static final int CORRECTION_SPEED = 55;
	...
	/**
	 * This method reset the acceleration of the motors
	 * 
