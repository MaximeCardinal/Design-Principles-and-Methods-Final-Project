 ...
 * @version 1.4
 * @editHistory Maxime Cardinal - Creation (29/10/2018)
 * 				Maxime Cardinal - Simplification of the class(method division) && JavaDoc improvment (02/11/2018) (1.1)
 * 				Maxime Cardinal - Modification of the class architecture (from thread to class), addition of a color 
 * 										differentiator for line detection, modification of the usLocalization and lsLocalization
 *  										algorithms to faster the overall localization (19/11/2018) (1.2)
 *  			Maxime Cardinal - Addition of the light differentiator used for line detection (23/11/2018) (1.3)
 *  			Irmak Pakis - Modification of the correction algorithm (25/11/2018) (1.4)
 *
 */
public class Localization {
	...
	private static final int DISTANCE_RANGE = 30;	
	...
	private static final double lineDetectionOffset = 0.20;
	...
	private static void angleCorrection() {
		...
		while (true) {
			...
			if (rightDetection < lineDetection && !rightDetected) {
				rightMotor.stop(!leftDetected);
				rightDetected = true;
			}
			if (leftDetection < lineDetection && !leftDetected) {
