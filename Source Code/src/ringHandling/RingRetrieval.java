...
public class RingRetrieval{
	...
	private static final int unloadOffset = 10;
	...
	public static void reachRingSet() {
		...
		leftClawMotor.rotate(-clawControl);
		rightClawMotor.rotate(-clawControl);
	...
	public static void ringUnloading() {
		...
		//move backward to its initial position
		leftMotor.rotate(-convertDistance(WHEEL_RAD, unloadOffset), true);
		rightMotor.rotate(-convertDistance(WHEEL_RAD, unloadOffset), false);
