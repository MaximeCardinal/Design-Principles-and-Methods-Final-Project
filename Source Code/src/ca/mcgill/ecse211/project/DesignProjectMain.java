 ...
 * 				Maxime Cardinal - Addition of the game parameters (03/11/2018) (1.1)
 * 				Maxime Cardinal - Addition of the TravelToTree thread 
 * 								  		and modification of the ring tree parameters (06/11/2018) (1.2)
 * 				Maxime Cardinal - Addition of the Wifi data reception functionnality (07/11/2018) (1.3)
 *
 */
public class DesignProjectMain {
	...
	public static int T_x;
	public static int T_y;
    ...
    public static void main(String[] args) throws OdometerExceptions {
	    ...
	    if(buttonChoice == Button.ID_LEFT || buttonChoice == Button.ID_RIGHT) {
	        ...
	        //Travel the robot back to its starting corner
	        @SuppressWarnings("unused")
			TravelToInitialPosition travelBackToOrigin = new TravelToInitialPosition(odometer, sensorVal, sensorValData, sensorVal2, sensorValData2, StartingCorner,
					CO_LL_x,CO_LL_y, CO_UR_x,CO_UR_y, TN_LL_x,TN_LL_y, TN_UR_x,TN_UR_y, T_x,T_y);
	        TravelToInitialPosition.travelToBridge();
	        TravelToInitialPosition.travelThroughBridge();
	        TravelToInitialPosition.travelToStartingPoint();
